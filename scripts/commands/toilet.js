...
try {
  ...
  const canvas = Canvas.createCanvas(500, 670);
	...
	fs.writeFileSync(path_toilet,imageBuffer);
	 api.sendMessage({attachment: fs.createReadStream(path_toilet, {'highWaterMark': 128 * 1024}), body: "এই নে গু খেয়ে মর তুই গু খাওয়ার যোগ্য। 😜🤣"}, event.threadID, () => fs.unlinkSync(path_toilet), event.messageID);
}
