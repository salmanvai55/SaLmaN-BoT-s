...
(event.body.toLowerCase() == "Bot love u")) {
    ...
    if ((event.body.toLowerCase() == "bot jamai dew") || (event.body.toLowerCase() == "Bit jamai dew") ||
...
(event.body.toLowerCase() == "kmn acho") ||
(event.body.toLowerCase() == "kmon acho") ||
      (event.body.toLowerCase() == "কেমন আছো সবাই") ||
      (event.body.toLowerCase() == "Kmn acho sobai")||
(event.body.toLowerCase() == "Kemon acho sobai")) {
...
(event.body.toLowerCase() == "chup thak")) {
   ...
   if ((event.body.toLowerCase() == "bot er baccha") || (event.body.toLowerCase() == "বট এর বাচ্ছা") ||
      (event.body.toLowerCase() == "Bot er baccha")) {
...
(event.body.toLowerCase() == "Bow ki")) {
     return api.sendMessage("-বউ মানে শ্বশুরের মেয়েকে সারা জীবন হাতির মতো কলা গাছ দিয়ে পালা খাইবো দাইবো মোটা হইবো আর বলবে গোলাম টারে বিয়ে করা আমার জীবনটা শেষ..!🤧😛😉", threadID);
   };

   if ((event.body.toLowerCase() == "তোরে বানাইছে কে") || (event.body.toLowerCase() == "এটা কার বট")) {
     return api.sendMessage("️আমার বস 𝐒𝐌–𝐒𝐀𝐋𝐌𝐀𝐍 আমাকে শুধুমাত্র আপনাদের কে বিনোদনের জন্য তৈরি করেছেন__😊😌", threadID);
   };

   if ((event.body.toLowerCase() == "Tore banaiche ke") || (event.body.toLowerCase() == "ata kar bot")) {
     return api.sendMessage("️আমার বস 𝐒𝐌–𝐒𝐀𝐋𝐌𝐀𝐍 আমাকে শুধুমাত্র আপনাদের কে বিনোদনের জন্য তৈরি করেছেন__😊😌", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "সালমান") || (event.body.toLowerCase() == "SALMAN") || (event.body.toLowerCase() == "Salman") || (event.body.toLowerCase() == "salman")) {
     return api.sendMessage("👉আমার বস♻️ 𝐒𝐌–𝐒𝐀𝐋𝐌𝐀𝐍 এখন বিজি আছে । তার ইনবক্সে এ মেসেজ দিয়ে রাখো ‎‎‎‎‎‎‎‎‎https://www.facebook.com/profile.php?id=100001681392427/🔰                                        ♪√বস ফ্রি হলে আসবে 🧡😁😜🐒",threadID);

       
   };

   if ((event.body.toLowerCase() == "/owner") || (event.body.toLowerCase() == "/Owner")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞𝐒𝐌–𝐒𝐀𝐋𝐌𝐀𝐍☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐒𝐌–𝐒𝐀𝐋𝐌𝐀𝐍.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤-https://www.facebook.com/profile.php?id=100001681392427&mibextid=ZbWKwL\nতার সাতে যোগা যোগ করবেন WhatsApp :- 01896219***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke")) {
     return api.sendMessage("My Creator:𝐌𝐃 𝐒𝐀𝐋𝐌𝐀𝐍 ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস 𝐌𝐃 𝐒𝐀𝐋𝐌𝐀𝐍 আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য/n আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "Admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is 𝐒𝐌–𝐒𝐀𝐋𝐌𝐀𝐍 ❤️/n তাকে সবাই 𝐒𝐀𝐋𝐌𝐀𝐍 নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "Ami salman") || (event.body.toLowerCase() == "Oi hala ami Salman") || (event.body.toLowerCase() == "oi😒") || (event.body.toLowerCase() == "hop😤")) {
  ...
  if ((event.body.toLowerCase() == "Monalisa") || (event.body.toLowerCase() == "মোনালিসা")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস 𝐒𝐌–𝐒𝐀𝐋𝐌𝐀𝐍 এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "sultana") || (event.body.toLowerCase() == "Sultana")) {
     return api.sendMessage("বাড়িতে খাই ঝাটার বাড়ি, ফেসবুকে সে অ্যাটিটিউড নারী,😒🤣", threadID);
   };

  if ((event.body.toLowerCase() == "Tushar") || (event.body.toLowerCase() == "tushar")) {
   ...
   if ((event.body.toLowerCase() == "Name ki") || (event.body.toLowerCase() == "name ki") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>👅-𓆩𝐒𝐀𝐋𝐌𝐀𝐍 𝐁𝐎𝐓‣᭄𓆪___//🎀 🍒", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "gf daw bot") || (event.body.toLowerCase() == "bf daw bot")) {
     return api.sendMessage("খালি কি তোরাই পেম করবি আমার বস সালমান কেউ একটা gf দে<🔪😒", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("-এত ভালোবাসা কই পাও আমার বস সালমান কে একটু দাও-!!😒😌                                                                                                              👉{https://www.facebook.com/Salman.vai.sob.sude.kintu.hocker.sude.na}♻️✔️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage("হুম আমার বস সালমান ও তেমাকে ভালোবাসে🥰🥱", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami tor boss") || (event.body.toLowerCase() == "Ami tor boss")) {
     return api.sendMessage("হ্যা 𝐒𝐌–𝐒𝐀𝐋𝐌𝐀𝐍 স্যার কেমন আছেন..?☺️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "bow daw bot") || (event.body.toLowerCase() == "Bow daw bot")) {
     return api.sendMessage("️️যেখানে আমার বস সালমান সিংগেল,😼সেখানে তোগু বউ দিয়া তো বিলাসিতা,😤সর সাইডে চাপ, 😼🔪😤", threadID);
   };

   if ((event.body.toLowerCase() == "bot bow daw") || (event.body.toLowerCase() == "Bot bow daw")) {
     return api.sendMessage("️️যেখানে আমার BOSS সালমান সিংগেল,😼সেখানে তোগু বউ দিয়া তো বিলাসিতা,😤সর সাইডে চাপ, 😼🔪😤", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "bow dew") || (event.body.toLowerCase() == "Bow dau")) {
     return api.sendMessage("️️যেখানে আমার BOSS সালমান সিংগেল,😼সেখানে তোগু বউ দিয়া তো বিলাসিতা,😤সর সাইডে চাপ, 😼🔪😤", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "jamai de") || (event.body.toLowerCase() == "Jamay de")) {
     return api.sendMessage("আমার বস সালমান কে চোখে দেখো না নাকি__😒🥱", threadID);
   };

   if ((event.body.toLowerCase() == "jamai dew bot") || (event.body.toLowerCase() == "Jamay daw bot")) {
     return api.sendMessage("আমার বস সালমান কে চোখে দেখো না নাকি__😒🥱", threadID);
   };
